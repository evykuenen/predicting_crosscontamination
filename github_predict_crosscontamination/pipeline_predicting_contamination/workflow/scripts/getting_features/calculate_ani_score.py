...
def calculate_ani(seqs_virus, batch_without_sample, log_file):
    ...
    if not seqs_virus or not batch_without_sample:
        ...
        # Gebruik een vaste directory in plaats van tempfile
    base_dir = r"/student_data/Evy/testing_ani/temp/"
    ...
    # Schrijf de FASTA-bestanden
    try:
        virus_fasta = os.path.join(genome_dir, "virus.fasta")
    ...
    try:
        sample_fasta = os.path.join(genome_dir, "sample.fasta")
    ...
    # Controleer of het resultaat-bestand bestaat
