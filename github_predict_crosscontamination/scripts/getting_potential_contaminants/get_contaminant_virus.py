...
def make_list_viruses_per_sample(samples):
    ...
    """
    filtered_samples = [[sample_id, list(samples[sample_id]["viruses"])]for sample_id in samples]
...
def main():
    ...
    path_to_extra_contig_names = Path("..\\..\\test_data\\data\\extra_krona_raporten_aanvraag_extra_contigs")
    clc_output_with_krona_virus_taxon_contigs_output = "..\\..\\test_data\\data\\Krona_output_archive_and_data"
    directory_name = "..\\..\\output_from_scripts\\potential_contaminants_output"

    # output
    path_potential_contaminants = "..\\..\\output_from_scripts\\potential_contaminants_output\\potential_contaminants.csv"
    potential_contaminants_with_non_foldable_krona_contigs = "..\\..\\output_from_scripts\\potential_contaminants_output\\potential_contaminants_with_non_foldable_krona_contigs.csv"
    potential_contaminants_with_contigs ="..\\..\\output_from_scripts\\potential_contaminants_output\\potential_contaminants_with_contigs.csv"
